...
var useVirtual = function (_a) {
    ...
    var measurements = React__namespace.useMemo(function () {
        ...
        for (var i = 0; i < numberOfItems; i++) {
            var size = cacheMeasure[i] || transformSize(i, estimateSize(i));
    ...
    var virtualItems = React__namespace.useMemo(function () {
        ...
        var _loop_1 = function (i) {
            ...
            var virtualItem = __assign(__assign({}, item), { visibility: visibilities[i] !== undefined ? visibilities[i] : -1, measureRef: function (ele) {
                    ...
                    var measuredSize = transformSize(i, {
                        height: rect.height,
                        width: rect.width,
                    });
...
var PageLayer = function (_a) {
    var doc = _a.doc, outlines = _a.outlines, pageIndex = _a.pageIndex, pageRotation = _a.pageRotation, pageSize = _a.pageSize, plugins = _a.plugins, renderPage = _a.renderPage, renderQueueKey = _a.renderQueueKey, rotation = _a.rotation, scale = _a.scale, shouldRender = _a.shouldRender, onExecuteNamedAction = _a.onExecuteNamedAction, onJumpToDest = _a.onJumpToDest, onRenderCompleted = _a.onRenderCompleted, onRotatePage = _a.onRotatePage;
    var isMounted = useIsMounted();
...
var DEFAULT_PAGE_LAYOUT = {
    ...
    tranformSize: function (_a) {
        var size = _a.size;
        return size;
    },
};
var Inner = function (_a) {
    var currentFile = _a.currentFile, defaultScale = _a.defaultScale, doc = _a.doc, initialPage = _a.initialPage, initialRotation = _a.initialRotation, initialScale = _a.initialScale, pageLayout = _a.pageLayout, pageSizes = _a.pageSizes, plugins = _a.plugins, renderPage = _a.renderPage, scrollMode = _a.scrollMode, viewerState = _a.viewerState, onDocumentLoad = _a.onDocumentLoad, onOpenFile = _a.onOpenFile, onPageChange = _a.onPageChange, onRotate = _a.onRotate, onRotatePage = _a.onRotatePage, onZoom = _a.onZoom;
    var numPages = doc.numPages;
    var docId = doc.loadingTask.docId;
    ...
    var _g = React__namespace.useState(initialScale), scale = _g[0], setScale = _g[1];
    ...
    var estimateSize = React__namespace.useCallback(function (index) {
        var sizes = [pageSizes[index].pageHeight, pageSizes[index].pageWidth];
    ...
    var transformSize = React__namespace.useCallback(function (pageIndex, size) { return layoutBuilder.tranformSize({ numPages: numPages, pageIndex: pageIndex, size: size }); }, []);
        ...
        getPage(doc, pageIndex).then(function (page) {
            ...
            switch (scaleTo) {
                case exports.SpecialZoomLevel.PageFit:
                    ...
                    break;
                case exports.SpecialZoomLevel.PageWidth:
                    updateScale = calculateScale(pagesContainer, pageSizes[pageIndex].pageHeight, pageSizes[pageIndex].pageWidth, exports.SpecialZoomLevel.PageWidth);
...
var PageSizeCalculator = function (_a) {
    ...
    var pagesRef = React__namespace.useRef();
    var _b = React__namespace.useState(1), initialScale = _b[0], setInitialScale = _b[1];
    var _c = React__namespace.useState([]), pageSizes = _c[0], setPageSizes = _c[1];
    React__namespace.useLayoutEffect(function () {
    ...
    return pageSizes.length === 0 ? (React__namespace.createElement("div", { className: "rpv-core__page-size-calculator", "data-testid": "core__page-size-calculating", ref: pagesRef },
        React__namespace.createElement(Spinner, null))) : (render(pageSizes, initialScale));
};
        ...
        React__namespace.createElement(ThemeContext.Provider, { value: themeContext },
            React__namespace.createElement("div", { ref: containerRef, className: "rpv-core__viewer rpv-core__viewer--".concat(themeContext.currentTheme), "data-testid": "core__viewer", style: {
                    ...
                    width: '100%',
                            ...
                            data: file.data,
                            name: file.name,
                        }, defaultScale: defaultScale, doc: doc, initialPage: initialPage, initialRotation: initialRotation, initialScale: initialScale, pageLayout: pageLayout, pageSizes: pageSizes, plugins: plugins, renderPage: renderPage, scrollMode: scrollMode, viewerState: {
                            file: file,
                            pageIndex: -1,
